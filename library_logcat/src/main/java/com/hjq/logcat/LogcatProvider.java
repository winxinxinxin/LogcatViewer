...
//            Boolean notifyEntrance = LogcatControl.getLogcatSetting().isLogcatNotifyEntranceOpen();
//            Boolean windowEntrance = LogcatControl.getLogcatSetting().isLogcatWindowEntranceOpen();

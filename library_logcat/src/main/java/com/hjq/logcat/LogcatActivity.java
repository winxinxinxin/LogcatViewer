...
public final class LogcatActivity extends AppCompatActivity
        ...
        CompoundButton.OnCheckedChangeListener, LogcatManager2.Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUpView = findViewById(R.id.ib_log_logcat_up);
...
//        Log.d("Logcat", "onReceiveLog::");
    ...
    public void onClick(View v) {
        if (v == mSaveView) {
            try {
                File file = LogcatUtils.saveCurLogToFile(this, mAdapter.getData());
//                if (file != null) {
...
//            LogcatManager2.pause();
            mPauseLogFlag = true;
        } else {
//            LogcatManager2.resume();
            mPauseLogFlag = false;
        }
    }
